...
//TODO: use inspectFile to find the JSON key file
...
module.exports = function(context) {
  //Find the option --publish in the command line string
        ...
        function(err, resp, callback) {
           if (err) {
              ...
              androidpublisher.edits.tracks.update({  // sets track of APK to Alpha
                 ...
                 track: 'alpha',
                 packageName: package,
                 resource: { versionCodes: [versionCode] }
              }, function(err, resp) { callback(null, err, resp); });
           }
        },
        function(err, resp, callback) {
